...
// 새 채팅방 생성 및 첫 메시지 전송
export const createChatMessage = async (userMessage, problemContext = {}) => {
  const { problemSetId, problemId } = problemContext;
  const body = { userMessage };

  if (problemSetId !== undefined && problemId !== undefined) {
    body.problemSetId = problemSetId;
